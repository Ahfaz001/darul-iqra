...
const Footer = () => {
  ...
  return (
    <footer className="relative bg-gradient-to-b from-emerald-700 via-emerald-800 to-emerald-900 dark:from-emerald-900 dark:via-slate-900 dark:to-slate-950 text-white overflow-hidden">
      {/* Decorative elements */}
